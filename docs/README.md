...
- si revisas estado tecnico real y riesgos vigentes: [engineering/REVIEW.md](./engineering/REVIEW.md)
...
- `engineering/`: esquema, estado técnico actual y planes activos realmente abiertos.
